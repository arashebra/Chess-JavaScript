            ...
            if (row - 1 >= 0)
                if (board[row - 1][column] == 0) {
                    ...
                    /*if (!is_player_throten_side())
                        board_on[row - 1][column] = 2;
                    else */if (!checkmate(true, mboard) || !is_player_throten_side())
                        board_on[row - 1][column] = 2;
                }
        }
        if (row - 1 >= 0)
...
// function get_situation_code(mboard) {
//     let m_situation_code = 0;
//     for (let row in board_on) {
//         for (let col in board_on) {
//             if (board_threat[row][col] == 3) {
//                 m_situation_code += mboard[row][col];
//             }
//         }
//     }
//     return m_situation_code;
// }
...
// function show_board_1() {
//     if (!player_order) {
//         board_dom_elem_1.classList.add('mute')
//     }
//     for (let row = 0; row < 8; row++) {
//         for (let column = 0; column < 8; column++) {
//             let id = 'id1_' + row + "_" + column;
//             let square = document.getElementById(id)
//             switch (board[row][column]) {
//                 case -1: square.innerHTML = Rook_black; break;
//                 case 1: square.innerHTML = Rook_white; break;
